...
(
    ...
    permissions  VARCHAR(255) NOT NULL, -- admin:read,admin:delete,customer:read etc
...
(
    ...
    -- date       DATETIME NOT NULL, can be used for expiration and so on
    FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE ON UPDATE CASCADE,
